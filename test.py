        ...
        try:
            ...
            if not result.empty:
                ...
                if len(player_name) < 5 :
                    ...
                    display_label = tk.Label(display_window, text=f"姓名: {player_name}, 號碼: {player_number}, 尺寸: {size}", font=("Helvetica", 30))
                # 將 "v" 寫回到對應的單元格
                ...
                display_label = tk.Label(display_window, text="找不到對應的選手信息", font=("Helvetica", 72))
